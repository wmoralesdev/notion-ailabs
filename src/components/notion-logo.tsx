...
type NotionLogoProps = SVGProps<SVGSVGElement> & {
  /** Visible height in px. Width is derived from the 256:268 aspect ratio. */
  size?: number
  /** When true, marks the SVG as decorative (use when adjacent text already names "Notion"). */
  decorative?: boolean
}
...
export function NotionLogo({
  ...
  const a11y = decorative
    ...
    : { role: "img" as const, "aria-label": "Notion" }
